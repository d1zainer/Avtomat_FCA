...
ExecStep xelab -m64 --incremental --debug typical --O2 --relax --mt auto -L work -L secureip --snapshot finit_avt_finit_avt_tb_func_impl --prj D:/lab_made/lab_3_of_4/lab_3_of_4.sim/sim_1/impl/func/finit_avt_finit_avt_tb.prj   work.finit_avt_finit_avt_tb
